...
function library:Window(text,logo,keybind)
	...
	Hub.Text = _G.Hub
	Hub.TextColor3 = Color3.fromRGB(59, 228, 228)
	Hub.TextSize = 17.000
	...
	SearchStroke.Color = Color3.fromRGB(59, 228, 228)
...
--[[
	...
	function uitab:Tab(text)
		...
		function main:Button(text,callback)
			...
			Button.BackgroundColor3 = Color3.fromRGB(59, 228, 228)
...
--[[
			...
			Button.MouseButton1Click:Connect(function()
				if toggled == false then
                    ...
                    TweenService:Create(
						Toggle,
						TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
						{BackgroundColor3 = Color3.fromRGB(59, 228, 228)}
					):Play()
					TweenService:Create(
						Circle,
						TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
		...
		function main:Slider(text,min,max,set,callback)
			...
			Slider.BackgroundColor3 = Color3.fromRGB(59, 228, 228)
			...
			bar1.Name = "bar1"
			bar1.Parent = bar
			bar1.BackgroundColor3 = Color3.fromRGB(59, 228, 228)
			...
			slidervalue.BackgroundColor3 = Color3.fromRGB(59, 228, 228)
		...
		function main:Textbox(text,disappear,callback)
			...
			Textbox.BackgroundColor3 = Color3.fromRGB(59, 228, 228)
		...
		function main:Seperator(text)
			...
			Sep1.BackgroundColor3 = Color3.fromRGB(59, 228, 228)
			...
			Sep3.BackgroundColor3 = Color3.fromRGB(59, 228, 228)
		...
		function main:Line()
			...
			Line.Name = "Line"
			Line.Parent = Linee
			Line.BackgroundColor3 = Color3.fromRGB(59, 228, 228)
...
function CheckQuest()
	...
	function Tween(gotoCFrame)
	   ...
	   if (game:GetService("Players")["LocalPlayer"].Character.HumanoidRootPart.Position - gotoCFrame.Position).Magnitude <= 170 then
		   pcall(function() 
			   tween:Cancel()
		   end)
...
coroutine.wrap(function()
    game:GetService("RunService").Stepped:Connect(function()
		if _G.Fastattack then
			if startATkmOb == true and (_G.AutoFarm or AutoSaber or Autothird or getgenv().AutoNew or _G.AutoTEST or _G.AutoFarmMBF or _G.AutoFarmGun or raidiing) then
				if getupvalues(CombatFramework)[2]['activeController'].timeToNextAttack then
					getupvalues(CombatFramework)[2]['activeController'].increment = 3
					getupvalues(CombatFramework)[2]['activeController'].timeToNextAttack = -(math.huge^math.huge)
					getupvalues(CombatFramework)[2]['activeController'].hitboxMagnitude = 55
...
HealthPersen = 20
AutoFarmTab:Slider("Health % ",HealthPersen,100,0,function(x)
    HealthPersen = x
end)
...
PointStats = 1
StastTab:Slider("Poins",PointStats,100,0,function(x)
    PointStats = x
end)
...
coroutine.wrap(function()
   pcall(function()
       game:GetService("RunService").Heartbeat:Connect(function()
           if _G.AutoFarm or getgenv().AutoNew or statetp1 or Autothird or _G.AutoTEST or _G.AutoFarmMBF or _G.AutoFarmGun then
...
spawn(function()
	game:GetService("RunService").Heartbeat:Connect(function()
	  pcall(function()
		  local MyLevel = game.Players.LocalPlayer.Data.Level.Value
			 if _G.AutoFarm or _G.AutoFarmGun or _G.AutoFarmMBF and startATkmOb and _G.Fastattack and StartMagnet or string.find(StartMagnet) and MyLevel == 2300 and StartMagnet then
				CheckQuest()
				   for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
					  if v.Name ~= "Ice Admiral [Lv. 700] [Boss]" and v.Name ~= "Don Swan [Lv. 3000] [Boss]" and v.Name ~= "Saber Expert [Lv. 200] [Boss]" and v.Name ~= "Longma [Lv. 2000] [Boss]" and (v.HumanoidRootPart.Position-PosMon.Position).magnitude <= 350 then --370
						 if v.Name == Ms then
