...
--                             game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
--                         end
--                         CFrame.new(0, 0, 0) = CFrame.new(0, 40, 0)
--                         wait(50)
...
coroutine.wrap(function()
   pcall(function()
       game:GetService("RunService").Heartbeat:Connect(function()
           if _G.AutoFarm or getgenv().AutoNew or statetp1 or Autothird or _G.AutoTEST or _G.AutoFarmMBF or _G.AutoFarmGun or _G.KenHaki then
        ...
        if _G.AutoFarm and StartMagnet then
            ...
            for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                if v.Name == Ms and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then  -- Ms คือตัวเเปลmonนะคับ
                    ...
                    elseif v.Name == Ms and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 350 then
                        if HideHitBlox then
                            v.HumanoidRootPart.Transparency = 1.5
                        else
                            v.HumanoidRootPart.Transparency = 50
